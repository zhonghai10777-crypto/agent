...
const zhMessages: Record<MessageKey, string> = {
  ...
  "vision.disclosure": "使用官方 DeepSeek Pro/Flash 时，图片会通过当前 DeepSeek 账号发送给 deepseek-v4-flash-vision-exp，再由原模型回答，并产生额外用量。全局图片上传限制优先。",
  ...
  "vision.testConfirm": "使用当前 DeepSeek 账号向 deepseek-v4-flash-vision-exp 发送一张不敏感的小图？本次请求会产生用量。",
