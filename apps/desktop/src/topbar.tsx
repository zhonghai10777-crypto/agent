    ...
    <header className="topbar" data-testid="topbar" onDoubleClick={handleDoubleClick}>
      <div className="topbar__title">
        <span className="topbar__workspace">
          {rootWorkspace ? rootWorkspace.name : t("app.openFolderToBegin")}
        </span>
                  ...
                  {activeWorktrees.map((worktree) => {
                    ...
                    return (
                      ...
                      >
                        {worktree.name}
                        {!worktreeSelectable
                          ? ` ${t("topbar.worktreeStatus", { status: worktree.status !== "ready" ? worktree.status : t("common.unavailable") })}`
                          : ""}
                      </button>
                    );
                  })}
      ...
      <div className="topbar__actions">
        ...
        <TopbarActionButton
          ...
          icon={<PromptRailIcon />}
          label={promptRailVisible ? t("topbar.hidePromptNav") : t("topbar.showPromptNav")}
